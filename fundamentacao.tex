...
\cite{Bezdek1984} e \cite{Pal2005} afirmam que a convergência desse modelo iterativo ocorre
...
Por fim está ilustrado na figura (\ref{fig:samples_fcm}), os resultados produzido pelo algoritmo FCM,
...
\footnotetext{Implementação na linguagem C do algoritmo FCM, disponível em: \url{https://github.com/niltonvasques/fcm}}
