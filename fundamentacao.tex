...
\begin{figure}[!htp] 
  ...
  \begin{minipage}{0.45\textwidth} 
    \centering
    \includegraphics[width=0.5\linewidth]{assets/clusters_crisp.pdf} 
    \captionof{figure}{Ilustração denotando os
grupos $g_1,g_2,g_3$ organizados sem sobreposição, para $m = 1$.} 
  ...
  \begin{minipage}{0.45\textwidth} 
    \centering
    \includegraphics[width=0.5\linewidth]{assets/clusters_fuzzy.pdf} 
    \captionof{figure}{Ilustração denotando os
