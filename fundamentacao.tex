...
A mineração de textos é um processo custoso, devido a variedade dos verbetes presente nos textos. 
E quanto maior for a coleção de textos, maior será a quantidade de palavras distintas. E isso eleva
bastante o custo computacional das tarefas da mineração de textos, que por sua vez são baseadas 
na análise do vocabulário dos documentos. Com isso, vários pesquisadores propuseram métodos para 
tentar simplificar, sintetizar e eliminar redundâncias desnecessárias nas coleções de textos.
...
suas palavras. Então ao final do processo, as palavras mais relevantes são utilizadas, e as demais
são descartadas.
