...
Ao contrário do FCM, o PCM não atribui pertinências dos documentos aos grupos, e sim tipicalidades. 
...
representa a tipicalidade do documento $d_i$ em relação ao grupo $g_j$.
\begin{equation}
...
\begin{figure}[!htp] 
  ...
  \caption{Demonstração de agrupamentos obtidos com os algoritmos 
    FCM (a) e PCM\protect\footnotemark(b)
  .} 
...
\section{Extração de descritores} \footnotetext{Resultados obtidos baseados na implementação
