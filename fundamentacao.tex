...
expansão de abreviações, radicalização, remoção de palavras terminais e por fim a seleção de 
características \cite{Haddi2013}. 
...
Como resultado final de todo o processo de pré-processamento, obtém-se uma matriz 
documentos x termos, onde as colunas da matriz são os termos da coleção, representados na forma
TF-IDF e as linhas os documentos.
