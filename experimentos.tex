...
Nos estudos do limiar $\delta$, detalhados na seção \ref{sec:softofdcl}, foi pontuado, que esse
limiar aplicado em partições possibilísticas poderiam resultar na mesmo $ranking$ de descritores
entre os grupos. Portanto, para comprovarmos as conclusões obtidas dessa investigação, vamos
analisar a lista dos descritores com maior pontuação em cada grupo, produzidas pelos métodos
Soft-FDCL, PDCL e Mixed-PFDCL.
