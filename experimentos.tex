...
\subsection{Investigações da extração de descritores em partições possibilísticas}
...
(equação \ref{eq:fcm_restri1}) do FCM. Essa é uma
...
Porém como já foi anunciado, a conversão sozinha não atende aos dois requisitos exigidos. Para isso
