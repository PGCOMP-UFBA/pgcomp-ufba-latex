...
A base de dados WAP({\it WebACE Project\/}) é composta de um conjunto de páginas web coletadas em
\cite{Moore1997}, para um projeto de pesquisa de agrupamento, seleção e recuperação de páginas web.
...
A base de dados Hitech adquirida em \cite{Karypis2006}, é parte de uma coleção de bases da 
